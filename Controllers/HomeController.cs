...
using UploadAndDisplayImageInAspDotNetCore.Data;
using UploadAndDisplayImageInAspDotNetCore.Models;
using UploadAndDisplayImageInAspDotNetCore.ViewModels;

namespace UploadAndDisplayImageInAspDotNetCore.Controllers
{
